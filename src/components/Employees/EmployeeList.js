...
const EmployeeList = () => {
  ...
  return (
    <div className="dashboard">
      ...
      <div className="container" style={{ maxWidth: '85%', marginLeft: 0 }}>
        ...
        <div className="mb-3 d-flex gap-2 flex-wrap">
          ...
          <Link to="/employees/new" className="btn btn-primary mb- fade-up">
            Add Employee
          </Link>
        </div>

        <div className="stat-card p-3"
          style={{ overflowX: 'auto', padding: '3rem', minWidth: '1350px' }}>
              ...
              {filteredEmployees.length > 0 ? (
                filteredEmployees.map((emp, index) => (
                  <tr key={emp.id}>
                    ...
                    <td className="text-start">{emp.role}</td>
                    <td className="text-start">{emp.department_name || 'N/A'}</td>
                    <td className="text-start">R{emp.salary}.00</td>
